<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="RemoverUser.aspx.cs" Inherits="siteProdutos.RemoverUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin-top: 15px; justify-content: center">
        <div style="text-align: center;">
            <asp:Button ID="btnDeletar" runat="server" CssClass="btn btn-danger" Text="Excluir" OnClick="btnDeletar_Click" />
        </div>
    </div>
    <div class="row" style="margin-top: 15px; justify-content: center">
        <div style="text-align: center;">
